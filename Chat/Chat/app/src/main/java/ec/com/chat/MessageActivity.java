...
import ec.com.chat.Model.User;
import ec.com.chat.Notifications.Client;
import ec.com.chat.Notifications.Data;
import ec.com.chat.Notifications.MyResponse;
import ec.com.chat.Notifications.Sender;
import ec.com.chat.Notifications.Token;
    ...
    private void sendMessage(String sender, final String receiver, String message, String uriPhoto,  boolean isFhoto) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                User user = dataSnapshot.getValue(User.class);
                if (notify) {
                    sendNotifiaction(receiver, user.getName() + " " + user.getLastname(), msg);
                }
                notify = false;
            }
